...
class AppConfig:
    ...
    @property
    def signal_journal_csv(self) -> Path:
        return self.base_dir / self.raw["paths"].get("signal_journal", "data/signal_journal.csv")
    ...
    @property
    def manual_positions_csv(self) -> Path:
        return self.base_dir / self.raw["paths"].get("manual_positions", "data/manual_positions.csv")
